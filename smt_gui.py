#!/usr/bin/env python3
"""Графический интерфейс контроллера SMT v4.20.3.
...
def build_app(root, selftest=False):
    ...
    diagnostic = DiagnosticRecorder(
        diag_folder, application="gui", version="4.20.3",
    ...
    root.title("Контроллер устройства 4.20.3 · 160 команд · AUTH-MODEL/KFACTOR/телеметрия")
